...
if flags.dibujarEMG
    ...
    disp(['Valor de gestoRespuesta antes de comprobar no gesto: ', num2str(gestoRespuesta)]); % Aquí se muestra el valor antes de entrar al if
    if gestoRespuesta == 6 || gestoRespuesta == 0 % variantes del no gesto
        ...
        if ~datosUsuario.gestoDibujado
            ...
            % Agregar un disp para ver el nombre del gesto
            disp(['Reconociendo gesto: ', nombreGestoRespuesta]);
            ...
            % Agregar un disp para ver el gesto repetido
            disp(['Gesto repetido: ', nombreGestoRespuesta]);
